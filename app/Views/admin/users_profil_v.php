            ...
            <div class="card">
                <div class="card-body pt-3">
                    ...
                    <ul class="nav nav-tabs nav-tabs-bordered">
                        ...
                        <?php if ($mitra_pengajar->ijazah != null) : ?>
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#pendukung-overview"> <i class="bi bi-users"></i> Data Pendukung</button>
                            </li>
                        <?php endif; ?>
                    </ul>
                    ...
                    <div class="tab-content pt-2">
                        ...
                        <?php if ($mitra_pengajar->ijazah != null) : ?>
                            <div class="tab-pane fade show active profile-overview" id="pendukung-overview">
