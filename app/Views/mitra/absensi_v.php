        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add_form">
                    ...
                    <div class="mb-3">
                        <label for="pergantian_jadwal" class="col-form-label">Pergantian Jadwal :</label>
                        <input type="date" class="form-control" id="pergantian_jadwal" name="pergantian_jadwal">
                        <div class="invalid-feedback error-pergantian-jadwal">
                        </div>
                    </div>
                ...
                success: function(response) {
                    ...
                    if (response.error) {
                        ...
                        if (response.error.pergantian_jadwal) {
                            $("#pergantian_jadwal").addClass('is-invalid');
                            $(".error-pergantian-jadwal").html(response.error.pergantian - jadwal);
                        } else {
                            $("#pergantian_jadwal").removeClass('is-invalid');
                            $(".error-pergantian-jadwal").html('');
                        }
