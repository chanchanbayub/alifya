...
use App\Models\Users\DataPendukungModel;
use App\Models\Users\DataPendukungMuridModel;
...
class UsersController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->dataPendukungMuridModel = new DataPendukungMuridModel();
    ...
    public function daftar_mitra_pengajar()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$this->validate([
                ...
                $mitra_pengajar = $this->pengajarModel->getPengajarIDTerakhir();

                $this->dataPendukungModel->save([
                    'mitra_pengajar_id' => $mitra_pengajar->id,
    ...
    public function daftar_peserta()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$this->validate([
                ...
                $peserta_didik = $this->muridModel->getMuridIDTerakhir();

                $this->dataPendukungMuridModel->save([
